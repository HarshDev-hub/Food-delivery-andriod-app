package com.example.fooddeliveryapp.prsentation.component
...
fun ExploreCard(
  ...
  androidx.compose.material3.Card (modifier = Modifier.size(width = 90.dp, height = 110.dp),
      ...
      Column(
          ...
          Text(
              text = name, fontSize = 14.sp, fontWeight = FontWeight.Bold, color = Color.DarkGray
          )
      }
  }
}
